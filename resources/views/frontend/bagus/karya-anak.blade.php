    ...
    {{-- Navigasi END --}}
        ...
        <header class="masthead text-center text-white position-relative">
            <div class="masthead-content">
                <div class="container px-5">
                    <h1 class="masthead-heading mb-0">Karya Anak Surabaya</h1>
        ...
        <section class="container-sm border border-dark rounded-top" >
            ...
            <div class="row py-lg-5 rounded-top" style="background-color: #a2094e" >
                <h3 class="text-center text-light">Karya Anak</h3>
            </div>
            <div class="row py-3">
                <!-- Content section 1-->
                <section id="scroll">
                    <div class="container px-5">
                        <div class="row gx-5 align-items-center">
                            <div class="col-lg-6 order-lg-2">
                                <div class="p-5"><img class="img-fluid rounded-circle" src="kegiatan-kecamatan/01.jpg" alt="..." /></div>
                            </div>
                    ...
                    <section>
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center">
                                <div class="col-lg-6">
                                    <div class="p-5"><img class="img-fluid rounded-circle" src="kegiatan-kecamatan/02.jpg" alt="..." /></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="p-5">
                    ...
                    <section>
                        <div class="container px-5">
                            <div class="row gx-5 align-items-center">
                                <div class="col-lg-6 order-lg-2">
                                    <div class="p-5"><img class="img-fluid rounded-circle" src="kegiatan-kecamatan/03.jpg" alt="..." /></div>
                                </div>
                                <div class="col-lg-6 order-lg-1">
                                    <div class="p-5">
