        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden hover-shadow">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-danger">Alur Sosialisasi dan Simulasi Bencana Kebakaran</h5>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-danger" id="modalLabel1">Alur Sosialisasi dan Simulasi Bencana Kebakaran</h5>
            ...
            <div class="col">
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden hover-shadow">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-danger">Alur Sosialisasi dan Simulasi Bencana Gempa Bumi</h5>
            ...
            <div class="col">
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden hover-shadow">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-danger">Pencegahan mempekerjakan anak di Aplikasi Assik</h5>
