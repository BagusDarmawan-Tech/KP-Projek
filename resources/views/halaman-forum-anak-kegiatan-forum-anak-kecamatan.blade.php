     ...
     <nav class="navbar navbar-expand-lg navbar-light shadow-sm py-4 " id="mainNav">
        <div class="container px-5">
            <a class="navbar-brand" href="#">
                <img src="logo.png" width="95" height="50" alt="">
            </a>
    ...
    {{-- Navigasi END --}}
            ...
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="p-5"><img class="img-fluid rounded-circle w-75 w-md-50 w-lg-25" src="kegiatan-kecamatan/01.jpg" alt="..." /></div>
                    </div>
        ...
        <section>
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6">
                        <div class="p-5"><img class="img-fluid rounded-circle w-75 w-md-50 w-lg-25" src="kegiatan-kecamatan/02.jpg" alt="..." /></div>
                    </div>
                    <div class="col-lg-6">
                        <div class="p-5">
                            <h2 class="display-4">Lorem ipsum dolor sit.</h2>
        ...
        <section>
            <div class="container px-5">
                <div class="row gx-5 align-items-center">
                    <div class="col-lg-6 order-lg-2">
                        <div class="p-5"><img class="img-fluid rounded-circle w-75 w-md-50 w-lg-25" src="kegiatan-kecamatan/03.jpg" alt="..." /></div>
                    </div>
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
