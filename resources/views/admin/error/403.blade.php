...
<head>
  ...
  <title>Pages / Akses ditolak 403</title>
  ...
  <main>
    <div class="container">
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        <h1 style="color: #ff6584">403</h1>
        <h2 class="text-center ">Anda tidak memiliki izin untuk mengakses halaman <br><span class="text-dark"> {{ $current_url }}</span></h2>
        <span></span>
