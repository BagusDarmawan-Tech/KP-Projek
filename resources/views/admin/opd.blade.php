    ...
    <div class="card shadow-lg border-0 position-relative overflow-hidden mb-5">
        <div class="card-body mt-4">
            <div class="text-center mb-4">
                <h4 class="fw-bold">Organisasi Perangkat Daerah</h4>
            </div>
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div></div>
                @if (auth()->user()->hasPermissionTo('opd-add'))
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahArtikelModal">+ OPD</button> 
                @endif
            </div>
                ...
                <table class="table table-hover table-bordered align-middle text-center"  id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if (auth()->user()->hasPermissionTo('opd-edit'))
                                ...
                                @endif
                                <!-- Button Delete Modal -->
                                @if (auth()->user()->hasPermissionTo('opd-delete'))
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="myForm" action="{{ route('createOPD') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll(".edit-btn").forEach(button => {
            button.addEventListener("click", function() {
                ...
                document.getElementById("editForm").action = `/opd/update/${id}`;
            });
        });
    });
</script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        document.querySelectorAll(".delete-btn").forEach(button => {
            button.addEventListener("click", function() {
                ...
                document.getElementById("deleteForm").action = `/opd/hapus/${id}`;
            });
        });
    });
</script>
